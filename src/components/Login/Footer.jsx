...
const Donate = () => {
  ...
  return (
    <div className="flex flex-row items-center space-x-4">
      <Link
        href="https://liberapay.com/joshuaCold"
        target="blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2"
      >
        <p className="text-sm capitalize text-secondary-900">{t("donate")}</p>
        <Coffee color="gray" />
      </Link>
    </div>
  );
...
const Email = () => {
  ...
  return (
    <div className="flex flex-row items-center space-x-4">
      <Link href="mailto: joshzcold@gmail.com" className="flex items-center gap-2">
        <p className="text-sm capitalize text-secondary-900">{t("email")}</p>
        <Mail color="gray" />
      </Link>
    </div>
  );
  ...
  return (
    <div className="flex flex-row items-center space-x-4">
      <Link
        ...
        className="flex items-center gap-2"
      >
        <p className="text-sm capitalize text-secondary-900">{t("source code")}</p>
