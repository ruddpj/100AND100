...
export const WSAction = {
  ...
  PLAY_TITLE_SHORT_MUSIC: "play_title_short_music",
  PAUSE_TITLE_SHORT_MUSIC: "pause_title_short_music",
  TITLE_MUSIC_PLAYBACK_ERROR: "title_music_playback_error",
  TITLE_SHORT_MUSIC_PLAYBACK_ERROR: "title_short_music_playback_error",
  BUZZED: "buzzed",
